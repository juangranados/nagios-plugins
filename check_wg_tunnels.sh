...
#                 Syntax: "EndpointPairLocalAddr1-wgIpsecEndpointPairPeerAddr1 EndpointPairLocalAddr2-wgIpsecEndpointPairPeerAddr2"
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    --help)
      ...
      echo "                   Syntax: \"EndpointPairLocalAddr1-wgIpsecEndpointPairPeerAddr1 EndpointPairLocalAddr2-wgIpsecEndpointPairPeerAddr2\""
